...
<body class="bg-light">
    <nav class="navbar navbar-expand-sm navbar-light justify-content-center fixed-top"
        style="height: 15px; background-color: #222222">
            ...
            <ul class="navbar-nav mb-auto">
                ...
                <li class="nav-item btn-group">
                    ...
                    <div class="dropdown-menu justify-content-center sticky-top"
                        ...
                        style="z-index: 99; background-color: #333333; padding: 20px;">
                        <form action="/byteWorks/signin/select" method="get">
                            <div class="container">
                                <h1 class="h1" style="font-family: 'Gilroy-bold'; color: white;">Entre na ByteWorks!
                                </h1>
                                <div class="row">
                                    <div class="col-lg">
        ...
        <ul class="navbar-nav text-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/byteWorks/marketplace"
                    style="font-family: 'Gilroy-bold'; text-transform: uppercase;">
                    MARKETPLACE
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" style="font-size: 12px; font-weight: bold; text-transform: uppercase;"
                    href="/byteWorks/signup">
                    Cadastre-se
                </a>
            </li>
            <li class="nav-item">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer"
                    style="background-color: #333333; display: flex; justify-content: space-between;">
                    <h5 style="color: white;">Total:
                        <?php echo isset($_SESSION["carShoppingValue"]) ? number_format($_SESSION["carShoppingValue"], 2, ",", ".") : ""; ?>
                    </h5>
                    <?php if (isset($_SESSION["carShopping"]) && $_SESSION["carShopping"] != null) {
                    echo '
